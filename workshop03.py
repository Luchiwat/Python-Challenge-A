from jj import rectangle_area, circle_area, prism_volume, sphere_volume
from wow import rectangle_volume as cube_rectangle_volume, sphere_volume as cube_sphere_volume
